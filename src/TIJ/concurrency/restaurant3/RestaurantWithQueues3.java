//: concurrency/restaurant2/RestaurantWithQueues3.java
// {Args: 5}
package TIJ.concurrency.restaurant3;

import TIJ.enumerated.menu.*;
...
class Table implements Runnable {
    ...
    public String toString() {
        ...
        synchronized (customers) {
            for (Customer customer : customers) sb.append(customer.toString() + "\n");
        }
        return sb.substring(0, sb.length() - 1);
    }
}
...
class Customer implements Runnable {
    ...
    public void run() {
        ...
        // Now wait for each ordered plate: for(int i = 0; i < nPlates; i++)
        try {
...
class Restaurant implements Runnable {
    ...
    public void run() {
        try {
            while (!Thread.interrupted()) {
                // A new group of customers arrive; assign a // WaitPerson:
...
public class RestaurantWithQueues3 {
