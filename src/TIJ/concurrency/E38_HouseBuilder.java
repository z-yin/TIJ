...
class House {
    ...
    private boolean
            steel = false, concreteForms = false, concreteFoundation = false,
            plumbing = false, concreteSlab = false, framing = false;
...
class FootingsDigger implements Runnable {
    ...
    public FootingsDigger(HouseQueue cq) {
        houseQueue = cq;
    }
...
class SteelTeam extends Team {
    public SteelTeam(TeamPool pool) {
        super(pool);
    }
...
class ConcreteFormsTeam extends Team {
    public ConcreteFormsTeam(TeamPool pool) {
        super(pool);
    }
...
class PlumbingTeam extends Team {
    public PlumbingTeam(TeamPool pool) {
        super(pool);
    }
...
class ConcreteSlabTeam extends Team {
    public ConcreteSlabTeam(TeamPool pool) {
        super(pool);
    }
...
class FramingTeam extends Team {
    public FramingTeam(TeamPool pool) {
        super(pool);
    }
...
class TeamPool {
    ...
    hire(Class<? extends Team> teamType, HouseBuilder hb) throws InterruptedException {
        for (Team t : pool)
    ...
    public synchronized void release(Team t) {
        add(t);
    }
}
